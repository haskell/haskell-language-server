          ...
          tweaks = hself: hsuper:
            with haskell.lib; {
              ...
              implicit-hie-cradle = hself.callCabal2nix "implicit-hie-cradle"
                (builtins.fetchTarball {
                  url = "https://hackage.haskell.org/package/implicit-hie-cradle/implicit-hie-cradle-0.4.0.2.tar.gz";
                  sha256 = "sha256:0grf5l0rn0klp2mqb6hyjwby48nbxg1xypg2423p1gv3z5p744mg";
                }) { };
            };
