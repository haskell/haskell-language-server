...
codeActionTests =
  ...
  [
    codeActionTest "Splits line when block comment is followed by line haddock" "BlockCommentThenLineHaddock" [("Add \"TupleSections\"", "Contains TupleSections code action")]
  ,  codeActionTest "Splits line when block comment is followed by single-line block haddock" "BlockCommentThenSingleLineBlockHaddock" [("Add \"TupleSections\"", "Contains TupleSections code action")]
  ,  codeActionTest "Splits line when block comment is followed by multi-line block haddock" "BlockCommentThenMultiLineBlockHaddock" [("Add \"TupleSections\"", "Contains TupleSections code action")]
  -- ,  codeActionTest "Doesn't Split line when pragma is followed by line comment" "PragmaFollowedByLineComment" [("Add \"TupleSections\"", "Contains TupleSections code action")]
  -- , codeActionTest "Doesn't Split line when pragma is followed by single-line block comment" "PragmaFollowedBySingleLineBlockComment" [("Add \"TupleSections\"", "Contains TupleSections code action")]
  -- , codeActionTest "Splits line when pragma is followed by multi-line block comment" "PragmaFollowedByMultiLineBlockComment" [("Add \"TupleSections\"", "Contains TupleSections code action")]
  -- , codeActionTest "Splits line when pragma is followed by line haddock" "PragmaFollowedByLineHaddock" [("Add \"TupleSections\"", "Contains TupleSections code action")]
  -- , codeActionTest "Splits line when pragma is followed by single-line block haddock" "PragmaFollowedBySingleLineBlockHaddock" [("Add \"TupleSections\"", "Contains TupleSections code action")]
  -- , codeActionTest "Splits line when pragma is followed by multi-line block haddock" "PragmaFollowedByMultiLineBlockHaddock" [("Add \"TupleSections\"", "Contains TupleSections code action")]
  -- , codeActionTest "Splits line when pragma is followed by multi-line block haddock" "PragmaFollowedByMultiLineBlockHaddock" [("Add \"TupleSections\"", "Contains TupleSections code action")]
