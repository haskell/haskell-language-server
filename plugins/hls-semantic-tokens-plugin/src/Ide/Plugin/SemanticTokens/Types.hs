...
--
data SemanticTokenTypeI =
    TVariable -- Original variable, can be override The following
    -- by match
    | TPatternBind -- PatternBind, parameters, as values in let/in, case, lambda
    | TMatchBind -- MatchBind, valBind instance bind or regular bind
