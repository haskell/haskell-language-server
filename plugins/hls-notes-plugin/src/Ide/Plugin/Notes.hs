...
listReferences state _ param
    ...
    = do
        ...
        case noteOpt of
            ...
            Just note -> do
                notes <- runActionE "notes.definedNoteReferencess" state $ useE MkGetNoteReferences (toSomeFileInput nfp)
...
jumpToNote state _ param
    ...
    = do
        ...
        case noteOpt of
            ...
            Just note -> do
                notes <- runActionE "notes.definedNotes" state $ useE MkGetNotes (toSomeFileInput nfp)
                case HM.lookup note notes of
                  Nothing -> pure (InR (InR Null))
  ...
  = do
      ...
      case noteOpt of
        ...
        Just note -> do
          ...
          notes <- runActionE "notes.hover" state $ useE MkGetNotes (toSomeFileInput nfp)
          case HM.lookup note notes of
            ...
            Just nfp -> do
              ...
              notesMap <-
                runActionE "notes.completion.notes" state $
                  useE MkGetNotes (toSomeFileInput nfp)
