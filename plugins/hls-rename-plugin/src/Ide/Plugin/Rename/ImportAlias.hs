...
-- | Find the module name and alias declaration span at the cursor.
-- The cursor must be on the @Alias@ token in @import Module as Alias@, in which
-- case the function returns @Module@ and the span for @Alias@.
findImportAliasDeclAtPos                                                                            -- [ ] AI
    :: Position                                                                                     -- [ ] AI
    -> [LImportDecl GhcPs]                                                                          -- [ ] AI
    -> Maybe (ModuleName, RealSrcSpan)                                                              -- [ ] AI
findImportAliasDeclAtPos pos imports = listToMaybe                                                  -- [ ] AI
    [ (aliasName, aliasDeclSpan)                                                                    -- [ ] AI
...
-- | Find all module names and alias declaration spans for the qualifier at the
-- cursor. The cursor must be on the @Alias@ part of @Alias.name@.
-- Returns multiple module names if they share the same alias.
findImportAliasUseAtPos                                                                             -- [ ] AI
    :: Position                                                                                     -- [ ] AI
    -> [LHsDecl GhcPs]                                                                              -- [ ] AI
    -> [LImportDecl GhcPs]                                                                          -- [ ] AI
...
findImportAliasUseAtPos pos decls imports =                                                         -- [ ] AI
    case listToMaybe                                                                                -- [ ] AI
        ...
        , let aliasLength  = fromIntegral (length (moduleNameString moduleAlias))                   -- [ ] AI
              ...
              aliasRange   = Range                                                                  -- [ ] AI
                  ...
                  (Position (line - 1) (startColumn - 1 + aliasLength))                             -- [ ] AI
        , rangeContainsPosition aliasRange pos                                                      -- [ ] AI
        ] of                                                                                        -- [ ] AI
    Nothing ->                                                                                      -- [ ] AI
        []                                                                                          -- [ ] AI
    Just aliasAtPos ->                                                                              -- [ ] AI
...
aliasBasedRename state nfp uri oldAlias aliasSpan imports decls newNameText = do                    -- [ ] AI
    let duplicateAlias =                                                                            -- [ ] AI
            length [ ()                                                                             -- [ ] AI
                   | L _ decl      <- imports                                                       -- [ ] AI
    ...
    useSiteSpans <-                                                                                 -- [ ] AI
        ...
        then do                                                                                     -- [ ] AI
            actualMod <- resolveActualMod aliasSpan imports                                         -- [ ] AI
            case actualMod of                                                                       -- [ ] AI
                Nothing      -> throwError $ PluginInternalError                                    -- [ ] AI
                    "Cannot rename: could not resolve which module this alias belongs to."          -- [ ] AI
                Just modName ->                                                                     -- [ ] AI
                    importAliasUseSiteSpansDisambiguated state nfp oldAlias modName decls           -- [ ] AI
        else pure $ importAliasUseSiteSpans oldAlias decls                                          -- [ ] AI
    let declEdit      = importAliasDeclEdit newNameText aliasSpan                                   -- [ ] AI
...
importAliasUseSiteSpans                                                                             -- [ ] AI
    ...
    -> [LHsDecl GhcPs]                                                                              -- [ ] AI
    -> [RealSrcSpan]                                                                                -- [ ] AI
importAliasUseSiteSpans oldAlias decls =                                                            -- [ ] AI
    [ fullNameSpan                                                                                  -- [ ] AI
    | L (ann :: Anno RdrName) (Qual moduleAlias _) <- listify (const True) decls                    -- [ ] AI
...
disambiguateAliasAtPos                                                                              -- [ ] AI
    ...
    => IdeState                                                                                     -- [ ] AI
    -> NormalizedFilePath                                                                           -- [ ] AI
    -> [Name]               -- ^ names under the cursor, from 'getNamesAtPos'                       -- [ ] AI
    -> [LImportDecl GhcPs]                                                                          -- [ ] AI
    -> ExceptT PluginError m (Maybe (ModuleName, RealSrcSpan))                                      -- [ ] AI
disambiguateAliasAtPos state nfp namesAtCursor imports = do                                         -- [ ] AI
    ...
    pure $ listToMaybe $ do                                                                         -- [ ] AI
        ...
        let declSpec                 = is_decl impSpec                                              -- [ ] AI
            actualMod                = is_mod declSpec                                              -- [ ] AI
            aliasName                = is_as declSpec                                               -- [ ] AI
        L _ decl                    <- imports                                                      -- [ ] AI
        guard (unLoc (ideclName decl) == actualMod)                                                 -- [ ] AI
        Just locatedAlias           <- [ideclAs decl]                                               -- [ ] AI
        guard (unLoc locatedAlias == aliasName)                                                     -- [ ] AI
        RealSrcSpan aliasDeclSpan _ <- [locA locatedAlias]                                          -- [ ] AI
        pure (aliasName, aliasDeclSpan)                                                             -- [ ] AI

-- | Identify the actual module behind an alias by matching the alias                               -- [ ] AI
-- declaration span against the import list. Used in 'aliasBasedRename'                             -- [ ] AI
-- to find which module owns the alias when multiple imports share it.                              -- [ ] AI
resolveActualMod                                                                                    -- [ ] AI
    :: RealSrcSpan         -- ^ span of the alias token in the import declaration                   -- [ ] AI
    -> [LImportDecl GhcPs]                                                                          -- [ ] AI
    -> Maybe ModuleName                                                                             -- [ ] AI
resolveActualMod aliasSpan imports = listToMaybe                                                    -- [ ] AI
    [ unLoc (ideclName decl)                                                                        -- [ ] AI
    | L _ decl                  <- imports                                                          -- [ ] AI
    , Just locatedAlias         <- [ideclAs decl]                                                   -- [ ] AI
    , RealSrcSpan declSpan _    <- [locA locatedAlias]                                              -- [ ] AI
    , declSpan == aliasSpan                                                                         -- [ ] AI
    ]                                                                                               -- [ ] AI
...
importAliasUseSiteSpansDisambiguated                                                                -- [ ] AI
    ...
    => IdeState                                                                                     -- [ ] AI
    -> NormalizedFilePath                                                                           -- [ ] AI
    -> ModuleName          -- ^ alias, e.g. @L@                                                     -- [ ] AI
    -> ModuleName          -- ^ actual module, e.g. @Control.Lens@                                  -- [ ] AI
    -> [LHsDecl GhcPs]                                                                              -- [ ] AI
    -> ExceptT PluginError m [RealSrcSpan]                                                          -- [ ] AI
importAliasUseSiteSpansDisambiguated state nfp oldAlias actualMod decls = do                        -- [ ] AI
    tcModule <- runActionE "rename.useSiteSpans" state (useE TypeCheck nfp)                         -- [ ] AI
    let rdrEnv   = tcg_rdr_env (tmrTypechecked tcModule)                                            -- [ ] AI
        allSpans = importAliasUseSiteSpansWithOcc oldAlias decls                                    -- [ ] AI
    pure                                                                                            -- [ ] AI
        [ rsp                                                                                       -- [ ] AI
        | (occName, rsp) <- allSpans                                                                -- [ ] AI
        , gre            <- maybeToList                                                             -- [ ] AI
            (lookupGRE_RdrName (Qual oldAlias occName) rdrEnv)                                      -- [ ] AI
        , impSpec        <- gre_imp gre                                                             -- [ ] AI
        , is_mod (is_decl impSpec) == actualMod                                                     -- [ ] AI
        ]                                                                                           -- [ ] AI
