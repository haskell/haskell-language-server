...
import           Language.LSP.Protocol.Types                   (ClientCapabilities,
                                                                ...
                                                                WorkspaceEdit, toNormalizedFilePath, filePathToUri, TextDocumentIdentifier (TextDocumentIdentifier))
...
import Ide.Plugin.Cabal.Completion.Types (ParseCabalFields(..), ParseCabalFile (..))
